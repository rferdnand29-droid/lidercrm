 ...
 *    - nunca apaga snapshots locais de dados de negócio (Kanban/Clientes),
 *      pois eles podem conter gravações ainda não enviadas à nuvem;
...
(function(global){
  ...
  var PATCH_APP_VERSION = 'lf_v15_data_safe_20260901';
  ...
  function _shouldDropDerivedCache(key){
    /* Segurança de dados: nenhuma chave de domínio pode ser tratada como
       "cache descartável". lf6_u, lf_departments, lf6_kb_*, lf6_c_*,
       lf13_acts_*, chat, feed e lf13_lig_* podem conter alterações locais
       ainda não confirmadas pelo servidor. A reidratação remota continua
       acontecendo abaixo, mas nunca à custa de apagar a única cópia local. */
    return false;
  }
