...
(function () {
  ...
  function _wrapFetchAndCache() {
    ...
    wrapped.__lfWrapped = true;
    wrapped.__lfOrig = orig;
    // [FIX 20260916] Sem isso, a blindagem instalada por
    // lf-hotfix-notif-som-e-atividades-v1-20260804.js (defineProperty
    // com setter que só aceita __lfV3Safe/__lfHotfixSafe) rejeitava
    // esta atribuição silenciosamente — o debounce nunca entrava em
    // vigor de verdade. Este wrapper já delega pra "orig" corretamente
    // (preserva toda a lógica protetiva da cadeia anterior), então é
    // seguro marcar.
    wrapped.__lfV3Safe = !!(orig && (orig.__lfV3Safe || orig.__lfHotfixSafe));
    wrapped.__lfHotfixSafe = wrapped.__lfV3Safe;
