/* =====================================================================
 * js/performance.js
 * Correções de performance, drag & drop e robustez de login.
 *
 * Incorporado de: lf-perf-drag-login-fix-20260723.js
 *   1. Login #A — reset automático de lockout preso
 *   2. Login #B — watchdog de timeout no login (15s)
 *   3. Movimentação #C — guard-rail contra estado sujo no drag Kanban
 *   4. Lentidão #D — pausa polls quando app vai para background
 *   5. Lentidão #E — debounce global de resize/orientationchange
 *
 * Carregar após js/kanban.js e js/auth.js.
 * ===================================================================== */
/* ============================================================================
