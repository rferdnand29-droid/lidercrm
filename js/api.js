...
(function(global){
  ...
  async function request(url, opts) {
    ...
    // Não transformar automaticamente um erro de método em uma escrita.
    // Um GET acidental para uma rota POST/DELETE poderia executar uma
    // mutação só porque o servidor informou o método permitido. O chamador
    // deve corrigir explicitamente sua operação e receber o 405 original.
