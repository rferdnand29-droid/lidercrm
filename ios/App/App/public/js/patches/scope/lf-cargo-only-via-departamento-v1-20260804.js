...
(function(global){
  ...
  global.__lfFixCargoOnlyViaDeptV1=true;
  ...
  function _isRootAdm(uid){
    try{
      ...
      // LF-AUTHZ-ROOTADM-FIX-20260824: uid do ADM raiz namespaced
      // (ex.: 'adm_root_2026') também é ADM raiz. Espelha o fix do worker.
      if(typeof uid==='string' && /^adm(_|$)/i.test(uid)) return true;
      var S=global.S;
