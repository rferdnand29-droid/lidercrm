...
```
lidercrm/
├── index.html            # entry point principal (SPA completo)
├── app.html               # cópia quase idêntica de index.html (ver nota abaixo)
├── app-lite.html           # variante menor, só linka pros dois acima
...
│
├── diagnostics/               # observabilidade nova (logger, performance, crash-reporter...) — NÃO conectada ao app
│
└── docs/                    # você está aqui
