...
├── js/
│   └── lf-cargo-only-via-departamento-v1-20260804.js            ← patch frontend (aditivo)
...
### 3) Frontend
Copiar `js/lf-cargo-only-via-departamento-v1-20260804.js` para `js/patches/scope/` no projeto e incluí-lo em `app.html` e `index.html` **logo após** `js/auth.js`:
