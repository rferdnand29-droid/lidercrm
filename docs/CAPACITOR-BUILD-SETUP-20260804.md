...
carrega de fato (`index.html`, `app.html`, `404.html`,
...
Não havia nenhum arquivo de logo no repo — a logo (`Líder CRM`) só existia embutida em base64 no `<link rel="icon">`
