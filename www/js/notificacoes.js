...
function _alertNewNotifs(list){
  ...
  (list||[]).forEach(function(n){
    ...
    var title;
    if(n.type==='chat')title='💬 Nova mensagem — LIDER CRM';
    else if(n.type==='transfer')title='🔄 Novo responsável — LIDER CRM';
    else if(n.type==='activity')title='🔔 Nova atividade — LIDER CRM';
    else if(n.type==='automation')title='⚙️ Automação — LIDER CRM';
    else title='🔔 Novo aviso — LIDER CRM';
