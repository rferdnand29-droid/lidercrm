...
(function(global){
  ...
  function _wrapLogoutFns(){
    ...
    fns.forEach(function(fname){
      ...
      // Compartilha a marca com o patch v2 e com outros wrappers globais.
      // Sem propagar as marcas, v1 e v2 se reenvelopavam a cada retry de
      // 300ms, gerando dezenas de mensagens no console e múltiplos efeitos
      // colaterais no logout.
