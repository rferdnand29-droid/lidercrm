...
(function(){
  ...
  var _syncCfg = window.LiderCRM && window.LiderCRM.config && window.LiderCRM.config.sync || {};
  var GLOBAL_CHAT_POLL_MS   = Number(_syncCfg.globalChatPollMs) || 5000;
  var GLOBAL_INBOX_POLL_MS  = Number(_syncCfg.globalInboxPollMs) || 15000;
