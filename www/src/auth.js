...
function toggleAdminNote(selId,noteId){
  ...
  var toggleId = 'eu-admin-toggle';
  if(selId==='k-cargo') toggleId = 'k-admin-toggle';
  if(selId==='nc') toggleId = 'nc-admin-toggle';
  var adminToggle=document.getElementById(toggleId);
...
function loadCli(uid,cb){
  ...
  function applyServerList(server){
    ...
    if(mergedSig!==localSig)_cb(merged);
  }
