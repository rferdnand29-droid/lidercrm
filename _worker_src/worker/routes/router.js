...
import {
  checkOverdueActivitiesController,
...
const ROUTES = [
  ...
  // 2026-08-07 — verificação periódica de atividades atrasadas, chamada
  // por um Worker de cron externo (Cloudflare Pages não suporta Cron
  // Triggers diretamente). Autenticação própria via X-Cron-Secret, ver
  // controllers/cron-controller.js e middlewares/auth.js.
  ['/api/v1/cron/check-overdue-activities', 'POST',   checkOverdueActivitiesController],
