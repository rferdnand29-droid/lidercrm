...
| `password.js` | `hashPasswordS2()` / verificação — a implementação de hash de senha REAL usada hoje pelo sistema (não confundir com `js/hash.js`, que parece órfão — ver `docs/ai-guide.md` § achados). |
