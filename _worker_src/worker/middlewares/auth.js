...
const PUBLIC_PATHS = new Set([
  ...
  // 2026-08-07: sem usuário logado nesse contexto (chamado por um
  // Worker de cron externo, não por um cliente do app) — a própria
  // controller valida um segredo compartilhado (X-Cron-Secret) em vez
  // de JWT. Ver controllers/cron-controller.js.
  '/api/v1/cron/check-overdue-activities',
]);
